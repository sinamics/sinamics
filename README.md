...
- [Use sparse checkout during installation](https://github.com/sinamics/ztnet/pull/613) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (1 day ago)
- [Dependencies update](https://github.com/sinamics/ztnet/pull/612) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (1 day ago)
- [Added tot/act for members in the Network table.](https://github.com/sinamics/ztnet/pull/610) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (5 days ago)
- [Improved global node naming](https://github.com/sinamics/ztnet/pull/607) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (6 days ago)
- [Added option to set sitename in admin panel](https://github.com/sinamics/ztnet/pull/605) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (1 week ago)
- [Added email verification icon and lastseen to admin user-table.](https://github.com/sinamics/ztnet/pull/604) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (1 week ago)
- [Updated docs for keycloak oauth](https://github.com/sinamics/ztnet/pull/601) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (2 weeks ago)
- [Fix missing translations](https://github.com/sinamics/ztnet/pull/599) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (2 weeks ago)
- [Update zerotier to 1.14.2](https://github.com/sinamics/ztnet/pull/592) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (2 weeks ago)
- [Improved smtp mail handler](https://github.com/sinamics/ztnet/pull/582) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (1 month ago)
...
- [invoiceninja/invoiceninja](https://github.com/invoiceninja/invoiceninja) - A source-available invoice, quote, project and time-tracking app built with Laravel (1 week ago)
