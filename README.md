...
- [blakeblackshear/frigate](https://github.com/blakeblackshear/frigate) ([v0.13.0-beta6](https://github.com/blakeblackshear/frigate/releases/tag/v0.13.0-beta6), 4 days ago) - NVR with realtime local object detection for IP cameras
...
- [Integrate postgres to ztnet container](https://github.com/sinamics/ztnet/pull/195) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (4 weeks ago)
- [Change user ID in database from int to 25char id](https://github.com/sinamics/ztnet/pull/191) on [sinamics/ztnet](https://github.com/sinamics/ztnet) (4 weeks ago)
